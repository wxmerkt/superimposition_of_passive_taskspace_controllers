#include "stack_of_passive_controllers_controller/stack_of_task_space_controllers.hpp"
...
StackOfTaskSpaceControllersController::StackOfTaskSpaceControllersController(ros::NodeHandle& n)
{
    ...
    sub_command_ = n.subscribe<std_msgs::Float64MultiArray>("command", 1, &StackOfTaskSpaceControllersController::commandCB, this);
...
void StackOfTaskSpaceControllersController::ddrCB(const ddynamic_reconfigure::DDMap& map, int, StackOfTaskSpaceControllersController* obj)
{
...
void StackOfTaskSpaceControllersController::commandCB(const std_msgs::Float64MultiArrayConstPtr& msg)
{
    // Positions
